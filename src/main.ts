...
window.addEventListener("load", function () {
	document.querySelector("#container")?.addEventListener("keydown", lineKeyboardEvent)
	document.querySelector("#container")?.addEventListener("beforeinput", (e) => console.log(e))
